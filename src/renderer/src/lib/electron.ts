import '../env.d.ts'
import { electronWhatsApp } from './electronWhatsApp'
...
export const electron = {
    ...
    // WhatsApp operations — delegated to dedicated module
    // see: src/renderer/src/lib/electronWhatsApp.ts
    whatsapp: electronWhatsApp,
}
